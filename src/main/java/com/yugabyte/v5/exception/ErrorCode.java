package com.yugabyte.v5.exception;
...
public enum ErrorCode {
    ...
    INVALID_TABLE_NAME("InvalidTableName", "無効なテーブル名です"),
    INVALID_HTTP_METHOD("InvalidHttpMethod", "無効なHTTPメソッドです"),
    ...
    CONFIG_MISSING("ConfigMissing", "データベース接続設定が不足しています"),
